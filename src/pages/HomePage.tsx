        ...
        <section className="relative bg-stone-900 text-white overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28 lg:py-32">
            <div className="max-w-2xl space-y-6 animate-slide-up">
              <Badge className="bg-primary/20 text-primary-foreground hover:bg-primary/30 border-primary/30 px-3 py-1 text-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {MOCK_RESTAURANTS.map((restaurant) => (
                <Link 
                  ...
                  className="group flex flex-col bg-card rounded-2xl overflow-hidden border shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
